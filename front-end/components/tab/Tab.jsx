...
const Tab = (props) => {
  return (
    ...
    >
      <div
        className={`whole ${props.height} rounded-md bg-${props.backgroundColor} flex overflow-hidden`}
      >
        {props.children}
        {props.imagePosition ? (
          <Image
        ...
        <div
          className={
            props.children
              ? "hidden"
              : `flex p-8 text-center rounded-md ${props.contentPosition} absolute z-50 content ${props.contentHeight} items-center bg-red-700/95 ${props.contentWidth}`
          }
        >
